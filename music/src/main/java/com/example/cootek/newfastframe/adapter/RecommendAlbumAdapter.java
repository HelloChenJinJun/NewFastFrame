...
public class RecommendAlbumAdapter extends BaseRecyclerAdapter<RecommendSongBean.ResultBeanXXXXXXXXXXXXXX.Mix1Bean.ResultBean, BaseWrappedViewHolder> {
    @Override
    ...
    @Override
    protected void convert(BaseWrappedViewHolder holder, RecommendSongBean.ResultBeanXXXXXXXXXXXXXX.Mix1Bean.ResultBean data) {
