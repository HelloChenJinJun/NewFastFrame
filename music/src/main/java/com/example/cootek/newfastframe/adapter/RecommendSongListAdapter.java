...
public class RecommendSongListAdapter extends BaseRecyclerAdapter<RecommendSongBean.ResultBeanXXXXXXXXXXXXXX
        .DiyBean.ResultBeanXXXXXXXXXXXX, BaseWrappedViewHolder> {
    @Override
    ...
    @Override
    protected void convert(BaseWrappedViewHolder holder, RecommendSongBean.ResultBeanXXXXXXXXXXXXXX
            .DiyBean.ResultBeanXXXXXXXXXXXX data) {
