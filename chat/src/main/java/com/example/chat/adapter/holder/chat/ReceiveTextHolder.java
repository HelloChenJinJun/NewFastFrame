...
public class ReceiveTextHolder extends BaseChatHolder {
        public ReceiveTextHolder(View itemView) {
                ...
                viewStub.setLayoutResource(R.layout.item_activity_chat_receive_text);
                viewStub.inflate();
        }
        ...
        public void bindData(BaseMessage baseMessage, UserEntity userEntity) {
                ...
                setText(R.id.tv_item_activity_chat_receive_text,FaceTextUtil.toSpannableString(getContext(),messageContent.getContent()));
        }
