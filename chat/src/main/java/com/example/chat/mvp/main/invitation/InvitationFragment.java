 ...
 * QQ:             1981367757
 */
public class InvitationFragment extends BaseFragment implements CustomSwipeRefreshLayout.OnRefreshListener {
    ...
    public void initView() {
        ...
        refresh = (CustomSwipeRefreshLayout) findViewById(R.id.refresh_fragment_invitation_refresh);
    ...
    public void initData() {
        ...
        display.setSwipeMenuItemClickListener((closeable, adapterPosition, menuPosition, direction) -> {
            ...
            //            (() getParentFragment()).notifyMenuUpdate(2);
        });
