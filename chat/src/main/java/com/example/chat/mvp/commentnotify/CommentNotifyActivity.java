...
public class CommentNotifyActivity extends ChatBaseActivity<List<PostNotifyBean>, CommentNotifyPresenter> implements OnLoadMoreListener, CustomSwipeRefreshLayout.OnRefreshListener {
    ...
    protected void initView() {
        refresh = findViewById(R.id.refresh_activity_comment_notify_refresh);
        refresh.setOnRefreshListener(this);
        display = findViewById(R.id.srcv_activity_comment_notify_display);
    }
    ...
    protected void initData() {
        DaggerCommentNotifyComponent.builder()
                ...
                .build().inject(this);
        data = (ArrayList<PostNotifyInfo>) getIntent().getSerializableExtra(ConstantUtil.DATA);
    ...
    public static void start(Activity activity, ArrayList<PostNotifyInfo> commentIdList) {
        ...
        intent.putExtra(ConstantUtil.DATA, commentIdList);
