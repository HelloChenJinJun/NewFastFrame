...
public class ConsumeQueryPresenter extends RxBasePresenter<IView<ConsumeQueryBean>,DefaultModel> {
    private int page=0;

    public ConsumeQueryPresenter(IView<ConsumeQueryBean> iView, DefaultModel baseModel) {
