 ...
 * 项目名称:    NewFastFrame
 * 创建人:        陈锦军
 * 创建时间:    2017/9/19      22:41
 * QQ:             1981367757
 */

public class BankCardItem {

   private BankCardInfoResult query_card ;

    public BankCardInfoResult getQuery_card() {
        return query_card;
    }

    public void setQuery_card(BankCardInfoResult query_card) {
        this.query_card = query_card;
    }

    public static class BankCardInfoResult{
        /**
         * retcode : 0
         * errmsg : 查询成功！
         * card : [{"account":"99225","name":"陈锦军","unsettle_amount":"0","db_balance":"2631","acc_status":"0","lostflag":"0","freezeflag":"0","barflag":"0","idflag":"1","expdate":"20180910","cardtype":"800","cardname":"正式卡","bankacc":"6217857600018226865","sno":"20141000341","phone":"","certtype":"","cert":"440804199509041633","createdate":"20140825","autotrans_limite":"2000","autotrans_amt":"5000","autotrans_flag":"1","mscard":"0","scard_num":"0"}]
         */
