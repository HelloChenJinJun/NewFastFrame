...
public class BaseDialog extends Dialog {
    ...
    private void initView() {
        topLayout = findViewById(R.id.ll_base_dialog_top);
        middleLayout = findViewById(R.id.ll_base_dialog_middle);
        bottomLayout = findViewById(R.id.ll_base_dialog_bottom);
        title = findViewById(R.id.tv_base_dialog_title);
        message = findViewById(R.id.tv_base_dialog_message);
        left = findViewById(R.id.tv_base_dialog_left);
        right = findViewById(R.id.tv_base_dialog_right);
    }
