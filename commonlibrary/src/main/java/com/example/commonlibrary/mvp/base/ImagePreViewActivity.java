...
public class ImagePreViewActivity extends BaseActivity {
    ...
    public static void start(Activity activity, ArrayList<String> data, int position, View view) {
    ...
    public void onBackPressed() {
        RxBusManager.getInstance().post(new PhotoPreEvent(display.getCurrentItem()));
        super.onBackPressed();
    }
