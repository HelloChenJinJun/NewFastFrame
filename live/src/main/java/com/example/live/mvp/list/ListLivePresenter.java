...
public class ListLivePresenter extends BasePresenter<IView<ListLiveBean>, DefaultModel>{
    public ListLivePresenter(IView<ListLiveBean> iView, DefaultModel baseModel) {
